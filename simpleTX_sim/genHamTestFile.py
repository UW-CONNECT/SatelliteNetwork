...
for hz in doppler_name_reservation:
    for SF in SF_list:
        N = 2**SF   
        symbols = np.ones(PAYLOAD_LEN)
        # symbols = []
        ...
        for BW in BW_list:
            ...
            # CR = 0 # coding rate, 0 for no hamming encoding, 1-4 for other corresponding options
                ...
                exp_folder = str(hz) + 'HzS_' + exp_folder
                ...
                print("OUTPUT TIME TO TRANSMIT: ", NUMPKTS*len(output)/FS)
