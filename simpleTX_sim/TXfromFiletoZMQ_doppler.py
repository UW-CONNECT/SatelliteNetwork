...
class TXfromFiletoZMQ_doppler(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        # Variables
        ##################################################
        self.samp_rate = samp_rate = 200e5
        ...
        self.blocks_file_source_0 = blocks.file_source(gr.sizeof_gr_complex*1, 'Z:\\schellberg\\indoor_exp_feb_2024\\SatelliteNetwork-main\\simpleTX_sim\\doppler_sim_scripts\\GNURADIO_linear_8k_sep', True, 0, 0)
