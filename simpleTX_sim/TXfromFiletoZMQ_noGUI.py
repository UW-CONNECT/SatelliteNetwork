...
class TXfromFiletoZMQ_noGUI(gr.top_block):

    def __init__(self):
        gr.top_block.__init__(self, "TXfromFiletoZMQ_noGUI")
...
def main(top_block_cls=TXfromFiletoZMQ_noGUI, options=None):
    tb = top_block_cls()
