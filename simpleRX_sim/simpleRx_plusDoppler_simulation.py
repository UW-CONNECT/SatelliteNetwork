...
class simpleRx_plusDoppler_simulation(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.channels_channel_model_1_0 = channels.channel_model(
            noise_voltage=.005,
            frequency_offset=0,
            epsilon=1.0,
            taps=[1],
        ...
        self.blocks_file_source_0_0 = blocks.file_source(gr.sizeof_gr_complex*1, 'Z:\\schellberg\\indoor_exp_feb_2024\\TEST_CONFIG\\0HzS_SF_7N_128BW_2500FS_200000NPKTS_50PLEN_100CR_0\\trial1', False, 0, 0)
        ...
        self.connect((self.blocks_throttle2_0, 0), (self.channels_channel_model_1_0, 0))
        self.connect((self.channels_channel_model_1_0, 0), (self.qtgui_sink_x_0, 0))
        self.connect((self.channels_channel_model_1_0, 0), (self.zeromq_pub_sink_0, 0))
