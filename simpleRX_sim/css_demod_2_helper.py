...
class CssDemod():
    ...
    def activity_detection(self, Rx_Buffer, BW, FS): 
        ...
        '''
        nfl = 0 # noise floor ? 
        uplink_wind = self.Active_Sess_SFAgn(Rx_Buffer, int(FS/BW), 7,2,nfl)
    ...
    def pkt_detection(self, Rx_Buffer, SF, BW, FS,  num_preamble):
        ...
        Dop_out = Pream_ind
        print("Pkt detection indices: ", Pream_ind)
    ...
    def check_doppler_preamble(self, N, FS, SF, BW, num_preamble, window_size, Rx_Buffer,ind):
        ...
        test_dop = Rx_Buffer[ind_win-5*window_size:ind_win-1*window_size]
