...
# Title: doppler_transponder_noGUI_0DOP
...
class doppler_transponder_noGUI_0DOP(gr.top_block):

    def __init__(self):
        gr.top_block.__init__(self, "doppler_transponder_noGUI_0DOP", catch_exceptions=True)
...
def main(top_block_cls=doppler_transponder_noGUI_0DOP, options=None):
    tb = top_block_cls()
