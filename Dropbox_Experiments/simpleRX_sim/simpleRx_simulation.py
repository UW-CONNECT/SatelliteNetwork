...
class simpleRx_simulation(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "simpleRx_simulation")
        ...
        self.blocks_file_source_0 = blocks.file_source(gr.sizeof_gr_complex*1, 'J:\\schellberg\\indoor_exp_feb_2024\\experiment_data\\snr_xlater_filter\\snr_0dB_SF7', False, 0, 0)
...
def main(top_block_cls=simpleRx_simulation, options=None):
