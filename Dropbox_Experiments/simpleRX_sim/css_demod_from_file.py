...
import numpy as np
from utils import *
from css_demod_2_helper import CssDemod
import zmq
...
# filename = r'J:\schellberg\indoor_exp_feb_2024\SatelliteNetwork-main\simpleRX_sim\sf7_highSNR'
# filename = r'J:\schellberg\indoor_exp_feb_2024\SatelliteNetwork-main\simpleRX_sim\sf7_highSNR'
filename = r'J:\schellberg\indoor_exp_feb_2024\SatelliteNetwork-main\simpleRX_sim\sf8_lowSNR'

# filename = r'J:\schellberg\indoor_exp_feb_2024\SatelliteNetwork-main\simpleRX_sim\sf7_mediumSNR'
# filename = r'J:\schellberg\indoor_exp_feb_2024\SatelliteNetwork-main\simpleRX_sim\sf7_lowSNR'
# filename = r'J:\schellberg\indoor_exp_feb_2024\SatelliteNetwork-main\simpleRX_sim\sf7_very_lowSNR'  #-7dB
# filename = r'J:\schellberg\indoor_exp_feb_2024\SatelliteNetwork-main\simpleRX_sim\sf7_more_lowSNR'
# filename = r'J:\schellberg\indoor_exp_feb_2024\SatelliteNetwork-main\simpleRX_sim\sf7_medium_lowSNR'
...
# DB_THRESH = -11
samp_start = 102397 
queue_tmp = queue[samp_start:] 
tt = np.arange(0, len(queue_tmp)) / FS 
doppler_slope = 50
fake_dop = tt * doppler_slope
fake_dop_vec = np.exp(1j * 2 * math.pi * doppler_slope * tt**2/2)
# fake_dop_vec_const = np.exp(1j * 2 * math.pi * 8000 * tt )
fake_dop_vec_const = 1
# fake_dop_vec = 1
print("Expected doppler value: ", doppler_slope * tt[-1])
queue_tmp = queue_tmp* fake_dop_vec*fake_dop_vec_const
queue[samp_start:] = queue_tmp
# plt.figure(1)
# plt.plot(queue)
# plt.show()
